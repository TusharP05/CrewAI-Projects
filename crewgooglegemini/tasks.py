...
link_finder= Task(
    description=(
        "search internet for the papers and journals related to {topic} and provide a list of 15 of them, along with their heading links and authors and date"),
